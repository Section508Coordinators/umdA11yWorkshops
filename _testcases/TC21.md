...
app-sc: |
  [Success Criterion 1.2.5: Audio Description (Prerecorded)](https://www.w3.org/WAI/WCAG22/Understanding/audio-description-prerecorded.html) - Audio description is provided for all prerecorded video content in synchronized media.
